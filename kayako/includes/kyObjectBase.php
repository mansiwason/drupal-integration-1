...
abstract class kyObjectBase {
	...
	/**
	 * Checks whether this object has all required fields set.
	 *
	 * @param bool $create True when object will be created. False when object will be updated.
	 ...
	 * Optionally you can return get method names used to filter objects.
	 *
	 ...
	 * Optionally you can return get method names used to order objects.
	 *
